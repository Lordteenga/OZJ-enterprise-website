...
1. Connect `ozjenterprise.com` to the production Vercel project and ensure HTTPS works. Redirect the www domain to the canonical apex domain in Vercel domain settings.
