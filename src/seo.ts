...
export const pages: Record<string, { title: string; description: string; noindex?: boolean }> = {
  ...
  "/team": { title: "Leadership Team | OZJ Oil & Gas", description: "Meet OZJ Oil & Gas leadership: Dr. Akintoye Akindele, Oshoma Zekeri, Ola Josh, Mope Abudu and Ozekhome Solomon Francis. Explore their experience in investment, operations, governance, procurement and energy infrastructure." },
  ...
  "/team/ozekhome-solomon-francis": { title: "Ozekhome Solomon Francis | Chief Procurement Officer, OZJ", description: "Meet Ozekhome Solomon Francis, Chief Procurement Officer at OZJ Enterprise Limited, leading strategic sourcing, supplier negotiations, and supply chain optimization." },
