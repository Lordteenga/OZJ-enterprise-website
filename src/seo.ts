...
export const pages: Record<string, { title: string; description: string; noindex?: boolean }> = {
  ...
  "/team": { title: "Leadership Team | OZJ Oil & Gas", description: "Meet OZJ Oil & Gas leadership: Dr. Akintoye Akindele, Oshoma Zekeri and Ola Josh. Explore their experience in investment, operations and energy infrastructure." },
